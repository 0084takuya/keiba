...
def main():
    validate_pythonpath('lightbgm_keiba_simple.py')
    global target_days
    target_days = parse_days_arg(sys.argv, 'lightbgm_keiba_simple.py')
    start_time = time.time()
    print('=== LightGBMモデル 実行開始 ===')
