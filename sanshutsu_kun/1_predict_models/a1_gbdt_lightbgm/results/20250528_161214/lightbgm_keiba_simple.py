...
def fetch_data():
    ...
    feature_cols = [
        ...
        'KISHU_CODE','CHOKYOSHI_CODE','KYORI','TRACK_CODE','SHUSSO_TOSU','KISHU_3IN_RATE','CHOKYOSHI_3IN_RATE','UMA_5R_3IN_RATE','RACE_KANKAKU','SHUSSO_KAISU','TENKO_JOTAI_GENZAI','BABA_JOTAI_SHIBA_GENZAI','BABA_JOTAI_DIRT_GENZAI','KISHU_CHOKYOSHI_PAIR_3IN_RATE','ZEN_5R_CHAKUJUN_MEAN','ZEN_5R_CHAKUJUN_DIFF','COURSE_3IN_RATE','COURSE_CHAKUJUN_MEAN','KYORI_3IN_RATE','KYORI_CHAKUJUN_MEAN','ZEN_5R_CHAKUJUN_SLOPE','ZEN_5R_BATAIJU_SLOPE'
    ]
