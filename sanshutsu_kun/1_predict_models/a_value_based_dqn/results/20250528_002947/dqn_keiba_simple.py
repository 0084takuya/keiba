...
def train():
    ...
    print('モデル保存済み')
    evaluate(model, X_test_cont, X_test_cat, y_test, train_losses, train_accuracies, run_dir)
...
def evaluate(model, X_test_cont, X_test_cat, y_test, train_losses, train_accuracies, run_dir):
